import { IconBriefcase, IconBrandFacebook, IconBrandInstagram, IconBrandGithub, IconBrandX, IconBrandYoutube } from "@tabler/icons-react";
...
const Footer = () => {
    ...
    return location.pathname!='/signup' && location.pathname!='/login'?<div className="flex flex-col gap-2"><div className="pt-20 pb-5 bg-mine-shaft-950 p-4  flex gap-8 justify-around flex-wrap">
        <div data-aos="fade-up"  data-aos-offset="0"  className="w-1/4 sm-mx:w-1/3   xs-mx:w-1/2 xsm-mx:w-full flex flex-col gap-4">
            <div className="flex gap-1 items-center text-bright-sun-400">
                ...
                <div className="text-xl font-semibold">HireSync</div>
            </div>
            <div className="text-sm text-mine-shaft-300">AI-powered recruitment platform with job management, candidate tracking, resume analysis, and scalable hiring workflows.</div>
            <div className="flex gap-3 text-bright-sun-400 [&>a]:bg-mine-shaft-900 [&>a]:p-2 [&>a]:rounded-full [&>a]:cursor-pointer hover:[&>a]:bg-mine-shaft-700">
                <a href="https://www.instagram.com/_somyasharma01/"><IconBrandInstagram /></a>
                <a href="https://github.com/Somyash07"><IconBrandGithub/></a>
    ...
    <div data-aos="flip-left"  data-aos-offset="0" className="font-medium text-center p-5">
        Designed & Developed By <a className="text-bright-sun-400 hover:underline font-semibold " href="https://www.linkedin.com/in/somya-sharma-93341124a/">Somya Sharma</a>
    </div>
    </div>:<></>
}
